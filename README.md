...
```text
checkers/
├── app.py            ← Main entry point: Streamlit UI, styling, and game loop.
├── game.py           ← Core engine: Board logic, move generation, and rule enforcement.
├── ai.py             ← AI implementation: Minimax (Alpha-Beta) and MCTS agents.
